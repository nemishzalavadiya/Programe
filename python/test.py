...
matrix=vector.fit_transform(documents)
## write code here ##

# extract score
score = matrix.toarray()[1][vector.get_feature_names().index('belt')]  # replace -1 with the score of 'belt' in document two. You can manually write the value by looking at the tf_idf model
